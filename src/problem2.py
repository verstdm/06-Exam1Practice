...
def problem2b(rect, n, delta, win):
    ...
    rect.attach_to(win)
    for i in range(n-1):
        rect1 = rg.Rectangle(rect.corner_1, rect.corner_2)
        rect1.corner_1.x = rect1.corner_1.x - delta * (i + 2)
        rect1.corner_1.y = rect1.corner_1.y + delta * (i + 2)
        rect1.corner_2.x = rect1.corner_2.x + delta * (i + 2)
        rect1.corner_2.y = rect1.corner_2.y - delta * (i + 2)
        rect1.attach_to(win)
    win.render()
