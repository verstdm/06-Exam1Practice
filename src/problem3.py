...
def run_test_problem3a():
    ...
    title = 'Problem 3a. Test 5: Start at (40, 30), 15 lines'
    ...
    title = 'Problem 3a. Test 6: Start at (40, 20), 10 lines'
...
def problem3a(window, point, n):
    ...
    count = 0
    for i in range(n):
        line = rg.Line(rg.Point(point.x + 20 * i, point.y + 10 * i), rg.Point(point.x + 20 * i, point.y + 50 + 10 * i))
        if thiqq < 13:
            line.thickness = 1 + 2 * i
        else:
            line.thickness = 13
        thiqq = line.thickness
        count = count + thiqq
...
def problem3b(m, point1):
    ...
    count1 = 0
    for i in range(m):
        count1 = count1 + problem3a(window, rg.Point(point1.x, point1.y + 60 * i), 2 * i + 3)
